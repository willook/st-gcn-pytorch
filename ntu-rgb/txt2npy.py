...
user_name = 'user'
save_npy_path = '/workspace/dataset/ntu-rgbd/skeletons/nturgbd_skeletons_s018_to_s032_npy/'
load_txt_path = '/workspace/dataset/ntu-rgbd/skeletons/nturgbd_skeletons_s018_to_s032/'
